...
import { approveRefund, type RefundActor } from "@/lib/refund";
...
export async function POST(req: NextRequest) {
  try {
    ...
    const approveCodManually = readBoolean(
      payload.approveCodManually ??
        payload.ApproveCodManually ??
    ...
    console.error("admin refund approve POST error", error);
