...
import RestroModal from '../admin/RestroModal'; // if you added RestroModal at components/admin/RestroModal.tsx
  ...
  return (
    <div>
      <div style={{ display: 'flex', gap: 8, marginBottom: 12 }}>
        ...
        <button onClick={openAdd} style={{ padding: '8px 12px', background: '#16a34a', color: '#fff', borderRadius: 6 }}>
          + Add New Restro
        </button>
      </div>
            ...
            <tbody>
              ...
              {list.map((r: any) => (
                <tr key={String(r.RestroCode)}>
                  ...
                  <td style={cell}>
                    <button onClick={() => openEdit(r)} style={{ padding: '6px 10px', borderRadius: 6, background: '#f59e0b', border: 'none' }}>
                      Edit
                    </button>
                  </td>
                </tr>
