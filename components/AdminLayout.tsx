...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  const [dark, setDark] = useState(() => {
    try {
      return localStorage.getItem("raileats-theme") === "dark";
    } catch {
      return false;
    }
  });
    ...
    <div className="min-h-screen flex bg-[var(--bg)] dark:bg-[#071018] text-[var(--text)]">
      ...
      <aside className="w-72 bg-white dark:bg-[#03141a] border-r border-slate-100 dark:border-[#042027] p-5">
        <div className="flex items-center gap-3 mb-6">
          <div className="w-12 h-12 rounded-lg bg-amber-400 flex items-center justify-center font-bold text-black">
            R
          </div>
        ...
        <nav className="space-y-1">
          <a
            href="/admin"
            className="flex items-center gap-3 p-3 rounded-lg hover:bg-slate-50 dark:hover:bg-[#041827]"
          >
            <Home size={18} />
      ...
      <div className="flex-1 flex flex-col min-h-screen">
        ...
        <header className="p-4 border-b border-slate-100 dark:border-[#05121a] bg-transparent">
          <div className="max-w-[1400px] mx-auto flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              <button className="p-2 rounded-md hover:bg-slate-100 dark:hover:bg-[#04121a]">
                <Bell size={18} />
              </button>
              ...
              <button
                ...
                className="p-2 rounded-md hover:bg-slate-100 dark:hover:bg-[#04121a]"
              >
