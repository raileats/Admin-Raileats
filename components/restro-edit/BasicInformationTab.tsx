...
export default function BasicInformationTab({ local, updateField, stationDisplay, InputWithIcon }: Props) {
  // fallback input (in case InputWithIcon not passed)
    ...
    <TabContainer title="Basic Information">
      <div className="restro-grid">
        ...
        <div className="field">
          ...
          <input className="restro-input" value={local?.OwnerPhone ?? ""} onChange={(e) => updateField("OwnerPhone", e.target.value)} />
        </div>
        ...
        <div className="field">
          ...
          <input className="restro-input" value={local?.RestroPhone ?? ""} onChange={(e) => updateField("RestroPhone", e.target.value)} />
        </div>
