...
// Adjust these imports if your repo uses different paths
...
export default function RestroEditModal({
  ...
  // Seed local state from server props
  useEffect(() => {
  ...
  // Compute robust restroCode (string) from available sources
  ...
  useEffect(() => {
    // helpful runtime debug in browser console (remove in production if you want)
    // eslint-disable-next-line no-console
    console.log("RestroEditModal mounted - restroCode:", restroCode);
  }, [restroCode]);
  ...
  // common props passed to tabs
  const common = {
    local,
    updateField,
  };

  // Render selected tab; IMPORTANT: ContactsTab MUST receive restroCode prop
  function renderTab() {
    switch (activeTab) {
      ...
      case "Contacts":
        // Pass restroCode explicitly — fixes the missing-prop TypeScript error
