...
export default function RestroEditModal({ restro, vendor, onClose, onSave, show = true }: Props) {
  ...
  useEffect(() => {
    console.log("DEBUG: RestroEditModal mounted", { restroCode });
  }, [restroCode]);
  ...
  const common = {
    local,
    updateField,
    // add more shared helpers/data here if needed
  };
  ...
  function renderTab() {
    switch (activeTab) {
      ...
      case "Contacts":
        // << IMPORTANT: pass restroCode prop explicitly to satisfy typing >>
