  ...
  return (
    <div className="basic-like-wrap">
      ...
      <style jsx>{`
        ...
        .basic-card { background: #fff; border-radius: 6px; border: 1px solid #eef6fb; padding: 18px; }
        .basic-heading { font-weight: 700; color: #0b5f8a; font-size: 18px; margin-bottom: 12px; }
        label { display: block; font-size: 13px; color: #333; margin-bottom: 6px; }
        .field.full textarea { width: 100%; min-height: 86px; padding: 10px 12px; border-radius: 6px; border: 1px solid #e6eef7; box-sizing: border-box; }
